#!/usr/bin/env python
"""
Detect onsets with vanilla pyPPG and save a NumPy file with all pulse-width (beat-to-beat) durations for a MAUS device (finger or wrist).
...
def durations_one_file(fpath: Path, fs: int, recording_site: str) -> list[float]:
    ...
    # Run pyPPG’s filter & derivatives 
    ...
    # Build a complete PPG object with all derivatives
    ...
    # Detect onsets and convert to ms 
